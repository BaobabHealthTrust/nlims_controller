module TB
  ...
  module  OrderService
    ...
    def self.confirm_order_request(ord)
          ...
          retr_order = TB::OrderService.retrieve_order_from_couch(couch_id)          
          ...
          TB::OrderService.update_couch_order(couch_id,retr_order)
    end
